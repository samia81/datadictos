<?php
	...
	$js_errmsg = "عذراً، حدث خطأ، ويمكن أن يتم حفظ التعليق الخاص بك. اتصل بالمسؤول عن الموقع.";
	$js_errmsg_ip = "يمكنك نشر تعليق مؤخرا، الرجاء الانتظار بضع دقائق قبل الترحيل مرة أخرى.";
	$CRLF = "\r\n";	
